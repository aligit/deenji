    ...
    <footer class="bg-secondary-800 text-white py-12">
      <div class="max-w-7xl mx-auto px-4">
        <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 class="text-lg font-semibold mb-4" i18n="@@aboutUs">
              About Us
            </h3>
            <ul class="space-y-2">
              <li>
          ...
          <div>
            <h3 class="text-lg font-semibold mb-4" i18n="@@resources">
              Resources
            </h3>
            <ul class="space-y-2">
              <li>
          ...
          <div>
            <h3 class="text-lg font-semibold mb-4" i18n="@@legal">Legal</h3>
            <ul class="space-y-2">
              <li>
                <a
                  href="#"
          ...
          <div>
            <h3 class="text-lg font-semibold mb-4" i18n="@@connect">Connect</h3>
            <div class="flex space-x-4">
              <a
                href="#"
                class="text-gray-300 hover:text-white"
                i18n-title="@@facebookTitle"
                title="Facebook"
              >
